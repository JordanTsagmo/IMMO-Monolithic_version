...
public class ProprietesController {
	...
	public @ResponseBody ResponseEntity<?> createProduct(@RequestParam("name") String name,
		...
		try {
			...
			String erreur="vous possedez deja une proprieté de ce nom";
			if (iProprietesServices.verificateurDoublonNomPropriete(this.bailleur,propriete.getName())==true)
			{
				model.addAttribute("erreur",erreur);
				return new ResponseEntity<>(HttpStatus.valueOf("propriete/AjouterPropriete"));
			}
			else{

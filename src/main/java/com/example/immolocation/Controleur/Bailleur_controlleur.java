  ...
  @Autowired
    ...
    */
    ...
    public String save(Model model, Bailleur bailleur, User user){
        ...
        if(iUserServices.checkIfExist(bailleur.getLogin())==true){
        System.out.print("le login est deja pris");
            String error = "ce login est deja utilisé,veillez choisir un autre";
            ...
            System.out.print("le login est disponible");

...
public interface IProprietesServices {
    ...
    /*
    cette methode permet de verifier si un bailleur possède deja une pro
    prieté enregistré sous un nom donné
     */
   boolean checkIfNameExist(Bailleur bailleur,String Name);

...
class ImmolocationApplicationTests {
    ...
    @Autowired
    IFactureServices iFactureServices;
    @Autowired
    ...
    public void checkIfExist() {
        User user=userService.findUserByLogin("marie rosa");
        if (user == null){
           System.out.println("faux sa n'existe pas");
        }
        else{
            System.out.println("vrai sa existe");
        }
    ...
    public void checkIfNameExist() {
        String Name="MOUSSA";
        Bailleur bailleur=iBailleurServices.rechercherBailleur("lka");
        ...
        if(proprietes.size()==0){
            ...
            System.out.println("le bailleur n'a aucune proprieté");
        }else{
            for(int i=0;i<proprietes.size();i++){
                if (proprietes.get(i).getName().equals(Name)){
                    answer=true;
                    System.out.println("le bailleur a une propriete du nom de "+Name);
                    break;
                }else {
                    answer=false;
                    System.out.println("le bailleur n'a aucune proprieté du nom de "+Name);
                    break;
                }
            }
        }
        System.out.println("le bailleur a une propriete .? :" +answer);
    ...
    @Test
    void facture(){
        List<Facture> factures=iFactureServices.Factures(1L);
